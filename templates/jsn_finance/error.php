                    ...
                    <div class="table">
                        <div class="table-cell">
                            ...
                            <div class="content-inner">
                                ...
                                <p>The page you are looking for has either expired or doesn't exist.</p>
                                <div class="back-home"><a class="" href="<?php echo JUri::base();?>"><?php echo JText::_('TPL_BACK_HOME');?></a></div>
                            </div>
                        </div>
                    </div>
                    <!-- End Content -->
